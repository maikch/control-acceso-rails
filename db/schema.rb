...
ActiveRecord::Schema.define(version: 20160912064206) do
  ...
  add_index "events", ["user_course_id"], name: "index_events_on_user_course_id", using: :btree
  ...
  add_index "nonces", ["user_id"], name: "index_nonces_on_user_id", using: :btree
  ...
  add_foreign_key "events", "user_courses"
